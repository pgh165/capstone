...
| 부품 | 모델 | 용도 | 예상 가격 |
|------|------|------|-----------|
| 메인 보드 | Raspberry Pi 4 (4GB) | 엣지 AI 처리 + LAMP 서버 | ~80,000원 |
| 카메라 | Pi Camera V2 | 얼굴 영상 촬영 | ~30,000원 |
| CO₂ 센서 | MH-Z19B | 이산화탄소 농도 측정 | ~20,000원 |
| 온습도 센서 | DHT22 | 실내 온도/습도 측정 | ~3,000원 |
| RGB LED | 공통 캐소드 | 상태 표시 (녹/황/적) | ~1,000원 |
| 부저 | 능동 부저 | 경고음 출력 | ~1,000원 |
| 기타 | 점퍼선, 브레드보드, 거치대 | 조립 및 고정 | ~5,000원 |
| **합계** | | | **~140,000원** |
